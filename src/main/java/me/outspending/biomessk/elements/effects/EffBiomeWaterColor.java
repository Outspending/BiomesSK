...
public class EffBiomeWaterColor extends Effect {

    static {
        Skript.registerEffect(EffBiomeWaterColor.class, "set water colo[u]r of %custombiome% to %color%");
    }
    ...
    protected void execute(Event event) {
        ...
        biome.setWaterColor(color.asRGB());
    }
