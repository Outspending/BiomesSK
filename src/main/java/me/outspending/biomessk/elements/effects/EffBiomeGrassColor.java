...
public class EffBiomeGrassColor extends Effect {

    static {
        Skript.registerEffect(EffBiomeGrassColor.class, "set grass colo[u]r of %custombiome% to %color%");
    }
    ...
    protected void execute(Event event) {
        ...
        biome.setGrassColor(color.asRGB());
    }
