...
public class EffBiomeSkyColor extends Effect {

    static {
        Skript.registerEffect(EffBiomeSkyColor.class, "set sky colo[u]r of %custombiome% to %color%");
    }
