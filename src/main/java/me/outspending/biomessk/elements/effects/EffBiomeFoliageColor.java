...
public class EffBiomeFoliageColor extends Effect {

    static {
        Skript.registerEffect(EffBiomeFoliageColor.class, "set foliage colo[u]r of %custombiome% to %color%");
    }
    ...
    protected void execute(Event event) {
        ...
        biome.setFoliageColor(color.asRGB());
    }
